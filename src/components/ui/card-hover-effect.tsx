      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-green-300/30 dark:bg-slate-600/30 block  rounded-3xl"
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-foreground hover:text-primary font-bold tracking-wide mt-4", className)}>
      {children}
    </h4>
  );
};
