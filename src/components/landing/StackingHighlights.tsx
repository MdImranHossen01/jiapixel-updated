    ...
    return (
        ...
        >
            <motion.div
                ...
                className={`w-full overflow-hidden bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl md:rounded-[2.5rem] shadow-2xl relative transition-all duration-500 hover:shadow-primary/10 hover:border-primary/20`}
            >
