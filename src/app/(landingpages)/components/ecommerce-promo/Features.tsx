...
export const Features = () => {
    const features = [
        ...
        // --- Core Tech & Performance ---
        {
            ...
            description: "সার্ভার খরচ নিয়ে চিন্তা করবেন না। আমরা আপনার স্টোরের জন্য প্রথম ৬ মাস হাই-পারফরম্যান্স ক্লাউড হোস্টিং দিচ্ছি একদম ফ্রি।",
            link: "#",
        },
        {
        ...
        },
        {
            ...
            description: "আপনার স্টোরের ডাটা ইনক্রিপ্ট রাখতে আমরা দিচ্ছি প্রথম ৬ মাসের জন্য ফ্রি এসএসএল সার্টিফিকেট।",
            link: "#",
        },
        {
