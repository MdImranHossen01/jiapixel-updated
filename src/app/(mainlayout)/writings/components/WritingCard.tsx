...
const WritingCard: React.FC<WritingCardProps> = ({ writing }) => {
    ...
    const handleDelete = async (e: React.MouseEvent) => {
        ...
        if (!confirm(`Are you sure you want to delete "${writing.title}"?`)) {
            return;
        }
        ...
        >
            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="text-sm text-muted-foreground">
                    {formatBlogDate(writing.publishedAt || writing.createdAt)}
                </div>
                        ...
                        <DropdownMenuContent align="end" className="border-0 shadow-lg">
                            ...
                            <DropdownMenuItem
                                onClick={(e) => {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    // Make sure this path exists for managing writings
                                    router.push(`/dashboard/admin/manage-writings/edit/${writing.slug}`);
                                }}
                            >
