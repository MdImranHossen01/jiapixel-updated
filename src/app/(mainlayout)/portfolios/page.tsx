...
  try {
    // Standardize URL usage for Server Components: use the public URL
...
export const metadata: Metadata = {
    title: 'Portfolios | Our Web Development & SEO Case Studies',
    description: 'Explore the portfolio of Jia Pixel, showcasing our best custom web development, e-commerce, and digital marketing projects that delivered measurable results.',
    alternates: {
        canonical: 'https://www.jiapixel.com/portfolios',
    },
    openGraph: {
        title: 'Portfolios | Jia Pixel Case Studies',
        description: 'Showcasing our best web development, e-commerce, and digital marketing projects.',
        url: 'https://www.jiapixel.com/portfolios',
    },
    // The rest of the OG/Twitter metadata will be inherited from the parent layout.
};
