...
// --- FIX: Model থেকে প্রয়োজনীয় টাইপস আমদানি করা হলো ---
import { IService, ITierData } from '@/models/Project'; 

// --- FIX: local interfaces removed as they are imported ---
interface PricingComponentProps {
  service?: IService; // Now uses the global IService type
}
...
  const [services, setServices] = React.useState<IService[]>([]); // Use IService[]
