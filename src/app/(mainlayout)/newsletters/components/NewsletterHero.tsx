...
const NewsletterHero: React.FC<NewsletterHeroProps> = ({ searchQuery, setSearchQuery }) => {
    return (
        <div className="relative bg-slate-900 overflow-hidden py-20 mb-12">
            ...
            <div className="absolute inset-0">
                <Image
                    ...
                    alt="Newsletter Hero Background"
                    fill
            ...
            <div className="container relative mx-auto px-4 text-center">
                ...
                <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
                    Stay updated with our latest newsletters, curated content, and exclusive updates.
                </p>
