...
const portfolioImages = [
  "https://i.ibb.co.com/YT8Qyw49/reviews3.png",
  "https://i.ibb.co.com/67Pc0tzf/reviews2.png",
  "https://i.ibb.co.com/Rk7QgycQ/reviews.png",
  "https://i.ibb.co.com/dJgytRFG/whoweare.png",
  "https://i.ibb.co.com/0VmyntPQ/aboutus.png",
  "https://i.ibb.co.com/S8Lmthf/banner4.png",
  "https://i.ibb.co.com/b5CPtVYg/productdeatils.png",
  "https://i.ibb.co.com/ZCNyDdY/login3.png",
  "https://i.ibb.co.com/DPDcBNLW/banner2.png",
  "https://i.ibb.co.com/C5fyB6p3/pricing3.png",
  "https://i.ibb.co.com/23f6zmxb/dashboard2.png",
  "https://i.ibb.co.com/N27nVhp2/dashboard.png",
  "https://i.ibb.co.com/fdJKGJsB/blog.png",
  "https://i.ibb.co.com/60CWFxxd/portfolio.png",
  "https://i.ibb.co.com/bcGGcLw/testimonial.png",
  "https://i.ibb.co.com/R4P5c8Yz/pricing2.png",
  "https://i.ibb.co.com/4wp7vqyv/pricing.png",
  "https://i.ibb.co.com/2xd4q73/product-cart.png",
  "https://i.ibb.co.com/SwQK8Wpf/Login-1.png",
  "https://i.ibb.co.com/trMdmzG/Login.png"
];
    ...
    return (
        <div className='container py-16 px-4 mx-auto grid md:grid-cols-2 gap-8 lg:gap-12 items-center'>
            ...
            <div className='flex flex-col justify-center space-y-6 md:space-y-8'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 py-2'>
                    ...
                    <div className='flex items-center gap-3 group'>
                        ...
                        <span className='text-foreground font-medium'>Modern Tech Stack</span>
                    </div>
                    <div className='flex items-center gap-3 group'>
                        <div className='flex items-center justify-center w-6 h-6 rounded-full bg-primary/20 group-hover:bg-primary/30 transition-colors'>
                            <CheckCircle className='w-4 h-4 text-primary shrink-0' />
                ...
                <div className='flex flex-col sm:flex-row gap-4 pt-6'>
                    ...
                    <Button variant='outline' className='px-8 py-3 text-lg rounded-xl font-semibold border-2 hover:bg-accent transition-all duration-300'>
                        Get Started
                    </Button>
                </div>
            ...
            <div className='relative flex h-[350px] md:h-[600px] justify-center gap-3 rounded-4xl lg:gap-4 overflow-hidden'>
                ...
                <Marquee vertical pauseOnHover reverse className="[--duration:90s] w-48 lg:w-52">
                ...
                <Marquee vertical pauseOnHover className="[--duration:85s] w-48 lg:w-52">
